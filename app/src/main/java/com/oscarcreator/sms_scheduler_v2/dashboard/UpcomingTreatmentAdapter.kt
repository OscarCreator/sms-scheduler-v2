...
class UpcomingTreatmentAdapter() : RecyclerView.Adapter<UpcomingTreatmentAdapter.UpcomingTreatmentViewHolder>() {
    ...
    var list: List<ScheduledTreatmentWithMessageTimeTemplateAndContact> = emptyList()
...
*/
    ...
    fun setScheduledTreatments(list: List<ScheduledTreatmentWithMessageTimeTemplateAndContact>){
        this.list = list
