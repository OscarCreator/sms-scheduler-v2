...
class DefaultTimeTemplatesRepository(
    ...
    override suspend fun getTimeTemplate(id: Long): TimeTemplate = timeTemplatesDataSource.getTimeTemplate(id)
    ...
    override suspend fun delete(timeTemplate: TimeTemplate): Int =
